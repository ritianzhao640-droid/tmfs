...
window.CONTRACT_CONFIG = {
    ...
    // 销毁分红合约地址 (新部署的 TAMABurnPool)
    dividendAddress: "0x3d286e64A1591870B914530fB1F37ac6B6739D0D",
    ...
    dividendABI: [
        ...
        },
        {
            ...
            "inputs": [
                ...
                {"indexed": false, "internalType": "uint256", "name": "amount", "type": "uint256"},
                {"indexed": false, "internalType": "uint256", "name": "newDividendPerShare", "type": "uint256"}
            ],
            "name": "PoolFunded",
            "type": "event"
        },
        ...
        },
        {
            ...
            "outputs": [
                ...
                {"internalType": "uint256", "name": "_totalDividend", "type": "uint256"},
                {"internalType": "uint256", "name": "_totalClaimed", "type": "uint256"},
                {"internalType": "uint256", "name": "_remaining", "type": "uint256"},
                {"internalType": "uint256", "name": "_dividendPerShare", "type": "uint256"}
            ],
            "stateMutability": "view",
            "type": "function"
        },
        ...
        },
        {
            ...
            "outputs": [
                ...
                {"internalType": "uint256", "name": "dividendPerShareAtBurn", "type": "uint256"}
            ],
            "stateMutability": "view",
            "type": "function"
        },
